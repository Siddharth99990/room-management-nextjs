...
const HomePage = () => {
    ...
    const handlePreviousRoom = () => {
      ...
      const handleNextRoom = () => {
        setRoomIndex((prev) => (prev < featuredRooms.length - 1 ? prev + 1 : prev))
    }
    ...
    useEffect(()=>{
        const fetchUserCount=async()=>{
            try{
                ...
                console.error("Error fetching user length",err);
                setUserLength(0);
            }finally{
  ...
  const roomFeatures = [
    {
      ...
      description: `Browse through ${roomsData.length} meeting rooms across different floors and capacities.`,
    },
    {
                    ...
                    <div className='grid md:grid-cols-2 gap-6 mb-8'>
                        <div className='bg-white dark:bg-gray-800 backdrop-blur-xl rounded-2xl shadow-lg border border-red-500 dark:border-red-900 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300'>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <Link href='/registeruser' className='bg-red-100 dark:bg-red-500 dark:text-white p-2 rounded-lg hover:bg-red-300 dark:hover:bg-red-800 transition-colors'>
